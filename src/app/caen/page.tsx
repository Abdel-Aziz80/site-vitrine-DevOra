...
export const metadata: Metadata = {
  title: "Développeur web freelance à Caen | Création de site internet",
  description:
    "Développeur web freelance à Caen. Création de sites internet professionnels, refonte, SEO local et accompagnement digital. Devis gratuit.",
      ...
      <section className="relative overflow-hidden px-6 py-24 text-center">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-[#334155]">
            Vous avez besoin d’un site internet sérieux pour présenter votre activité à Caen ? Je vous accompagne avec une approche simple : un site propre, lisible, adapté à vos clients et conçu pour faciliter la prise de contact.
          </p>
      ...
      <section className="px-6 pb-24">
        <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-2">
          <div className="rounded-4xl border border-[#061A35]/10 bg-white p-8 shadow-sm md:p-10">
            ...
            <h2 className="text-3xl font-bold bg-linear-to-r from-[#061A35] via-[#173C91] to-[#2DBEB5] bg-clip-text text-transparent">Création de site internet à Caen</h2>
