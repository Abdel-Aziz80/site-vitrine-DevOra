          ...
          <div className="bg-white rounded-3xl border border-[#061A35]/10 shadow-sm p-8 md:p-10">
            ...
            >
              ...
              <input
                type="hidden"
                name="_subject"
                value="Nouvelle demande de devis depuis DevOra"
              />
              {/* Champ caché pour piéger les robots (anti‑spam honeypot). Les bots remplissent ce champ invisible. */}
              ...
              {/* Champ caché contenant le résumé de devis pour l’e‑mail */}
              {devisDecoded && (
                <input
                  type="hidden"
                  name="devis"
