    ...
    <main className="devora-page devora-immersive-page min-h-screen">
      ...
      <section className="px-6 py-20">
        <div className="max-w-6xl mx-auto grid items-start gap-8 lg:grid-cols-2">
          <div className="bg-white/[0.075] rounded-3xl border border-white/12 shadow-sm p-8 md:p-10">
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-white/12 bg-white/[0.075] px-4 py-3 text-white outline-none transition focus:border-[#173C91] focus:ring-2 focus:ring-[#B8F3ED]"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-2xl border border-white/12 bg-white/[0.075] px-4 py-3 text-white outline-none transition focus:border-[#173C91] focus:ring-2 focus:ring-[#B8F3ED]"
                  required
              ...
              <p className="text-center text-xs leading-5 text-white/48">
                Votre message est uniquement utilisé pour répondre à votre demande.
              </p>
            </form>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/[0.075] rounded-3xl border border-white/12 shadow-sm p-8 md:p-10">
              ...
              <div className="mt-5 grid gap-3 text-sm text-white/72">
                <p className="rounded-2xl bg-white/[0.07] p-4">
            ...
            <div className="bg-white/[0.075] rounded-3xl border border-white/12 shadow-sm p-8 md:p-10">
              ...
              <div className="mt-6 grid gap-3 text-sm font-medium">
                <a
                  ...
                  className="rounded-2xl border border-[#22D3EE]/15 bg-white/[0.07] p-4 text-[#67E8F9] transition hover:border-[#22D3EE]/35 hover:bg-[#22D3EE]/10"
                >
                  {contactEmail}
                </a>
