export type PortfolioProject = {
  ...
  pricing?: { name: string; price: string; description: string; included: string[]; highlight?: string }[];
...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    seoTitle: "DEVORA Sentinel - IA locale, surveillance défensive et visibilité système",
    seoDescription:
      "DEVORA Sentinel est un outil local de surveillance défensive, IA locale et visibilité système pour suivre les incidents, garder le contrôle et protéger les données sur le PC.",
    shortDescription:
      "Un outil local pour visualiser certaines activités techniques, suivre les incidents, comprendre les alertes et garder le contrôle sans cloud invasif.",
    context:
      "DEVORA Sentinel est le produit interne le plus avancé commercialement : un outil local, orienté confidentialité, conçu pour rendre la surveillance défensive plus compréhensible par les indépendants, développeurs, homelabs, studios et petites équipes.",
    problem:
      "Les signaux de risque sont souvent dispersés : changements inhabituels, alertes, événements système, fichiers sensibles, incidents ou actions non suivies. Sans lecture claire, il devient difficile de comprendre ce qui se passe et quoi traiter en premier.",
    solution:
      "Sentinel rassemble les informations utiles dans une interface locale, classe les alertes, garde un historique lisible et aide à préparer des actions défensives qui restent validées par l'utilisateur.",
    businessValue:
      "Aider un indépendant, développeur, studio, homelab ou TPE à mieux surveiller son environnement local, comprendre les incidents et garder ses données sensibles sur sa machine.",
    expectedResults: [
      "Alertes et incidents plus lisibles",
      "Meilleure visibilité sur l'environnement local",
      "Données conservées sur la machine par défaut",
      "Actions sensibles soumises à validation humaine",
    ],
    features: [
      "Vue locale des incidents",
      "Priorisation des signaux",
      "Historique lisible",
      "Vérification des événements importants",
      "Surveillance défensive",
      "IA locale pour aider à comprendre",
    ...
    launchOffer: {
      ...
      text: "Accès privé limité à 50 personnes, gratuit pendant 1 mois. Chaque demande est relue avant activation afin de confirmer le contexte, la compatibilité et l'usage prévu. Une version téléphone portable est en cours de développement, avec une priorité donnée à l'expérience locale desktop pour l'Early Access.",
      cta: "Rejoindre l'Early Access",
      href: "/portfolio/devora-sentinel#early-access",
    },
    sentinelOverview: {
      title: "Qu'est-ce que DEVORA Sentinel ?",
      lead:
        "DEVORA Sentinel est un outil local de surveillance et d'assistance défensive conçu pour aider à visualiser certaines activités système, suivre des signaux techniques et centraliser les incidents utiles depuis une seule interface. L'objectif n'est pas d'espionner : l'objectif est de rendre ce qui se passe sur la machine plus lisible, plus contrôlé et plus facile à traiter.",
      cards: [
        {
          title: "Local par conception",
          text: "Vos données et les informations suivies restent sur la machine par défaut. Sentinel est pensé pour fonctionner comme un assistant local, avec un contrôle utilisateur clair.",
        },
        {
          title: "Surveillance défensive",
          text: "Le logiciel aide à repérer des signaux, comprendre des incidents et organiser des actions de protection. Il ne remplace pas le jugement humain.",
        },
        {
          title: "IA locale utile",
          text: "L'IA sert à aider à lire, résumer et prioriser certains événements. Elle n'est pas présentée comme une magie autonome et ne doit pas agir sans validation.",
        },
        {
          title: "Transparence et contrôle",
          text: "Pas de revente de données, pas de collecte cachée, pas d'action automatique agressive. Les veilles externes utilisent uniquement des sources autorisées.",
        },
      ],
      guardrails: [
        "Ce n'est pas un spyware.",
        "Ce n'est pas un cloud invasif.",
        "Les données ne sont pas envoyées partout.",
        "Les actions sensibles restent validées manuellement.",
        "Les démonstrations détaillées se font en privé.",
      ],
    },
    pricing: [
      {
        ...
        price: "0€",
        highlight: "1 mois inclus",
        description: "Pour les 50 premiers accès validés manuellement. Idéal pour découvrir Sentinel avec un support direct fondateur.",
        included: ["50 accès maximum", "Activation manuelle", "Support direct fondateur", "Historique incidents", "Vue locale", "Validation humaine", "Version téléphone en développement", "Accès prioritaire aux évolutions"],
      },
      {
        name: "Sentinel Solo",
        price: "14,90€/mois",
        description: "Pour indépendant, créateur, homelab ou usage personnel avancé sur une machine moderne.",
        included: ["Vue incidents", "Exports simples", "2 projets max", "Surveillance locale", "Historique", "Support standard"],
      },
      {
        name: "Sentinel Developer",
        price: "29€/mois",
        description: "Pour développeur, studio ou environnement technique qui a besoin d'une lecture plus fine.",
        included: ["Sentinel Watch", "Veille défensive", "Surveillance renforcée", "5 projets max", "Exports avancés", "Logs enrichis"],
      },
      {
        name: "Sentinel Business",
        price: "79€/mois",
        description: "Pour TPE, agence ou équipe opérationnelle qui veut centraliser plusieurs périmètres.",
        included: ["Multi-projets", "Validation avancée", "Escalade incidents", "Response Gate", "Support prioritaire", "15 projets max"],
      },
      {
        name: "Sentinel Enterprise",
        price: "Sur devis",
        description: "Pour organisation qui demande une installation accompagnée, des règles dédiées ou une intégration spécifique.",
        included: ["Installation accompagnée", "Règles dédiées", "Politiques avancées", "Support personnalisé", "On-prem", "Intégration spécifique"],
      },
    ],
    options: [
      {
        ...
        price: "+29€",
        description: "Adaptation légère de l'interface avec vos couleurs, avec vérification du contraste.",
      },
      {
        name: "Installation accompagnée",
        price: "+49€",
        description: "Aide à l'installation, vérification de compatibilité et premier tour guidé.",
      },
      {
        name: "Configuration optimisation locale",
        price: "+29€",
        description: "Réglage de base pour un usage plus confortable selon votre machine.",
      },
      {
        name: "Surveillance avancée supplémentaire",
        price: "+9€/mois",
        description: "Extension d'un périmètre de surveillance selon les besoins validés.",
      },
      {
        name: "Historique incidents étendu",
        price: "+5€/mois",
        description: "Conservation plus longue de l'historique local des incidents.",
      },
    ],
    faq: [
      {
        question: "Pourquoi Sentinel est local ?",
        answer:
          "Parce que les événements surveillés peuvent être sensibles. DEVORA Sentinel est pensé pour garder les données sur votre machine par défaut et limiter les échanges externes au strict nécessaire.",
      },
      {
        question: "Que surveille Sentinel ?",
        answer:
          "Sentinel aide à suivre des signaux techniques, événements système, alertes, incidents, changements inhabituels, éléments à vérifier et historiques utiles. Les périmètres exacts dépendent du profil et de la configuration validée.",
      },
      {
        question: "Mes données quittent-elles mon PC ?",
        answer:
          "Par défaut, vos données restent sur votre machine. Certaines veilles externes peuvent utiliser Internet pour consulter des sources autorisées, mais l'objectif n'est pas d'envoyer vos données personnelles ou internes dans un cloud invasif.",
      },
      {
        question: "Pourquoi y a-t-il une IA locale ?",
        answer:
          "L'IA locale aide à résumer, classer et expliquer certains signaux. Elle sert à rendre les incidents plus compréhensibles, pas à prendre le contrôle de la machine.",
      },
      {
        question: "À quoi servent les veilles externes ?",
        answer:
          "Elles servent à enrichir la lecture défensive avec des sources autorisées : contexte de menace, informations publiques, signaux de veille ou documentation utile. Elles restent séparées de la logique de collecte cachée.",
      },
      {
        question: "Quelle différence avec un antivirus ?",
        answer:
          "Un antivirus cherche surtout à détecter et bloquer des menaces connues. Sentinel se positionne comme un outil de visibilité, suivi et assistance défensive : il aide à comprendre, prioriser et documenter ce qui mérite votre attention.",
      },
      {
        question: "Sentinel agit-il automatiquement ?",
        answer:
          "Non, l'approche est prudente : pas d'action agressive automatique. Les actions sensibles doivent rester visibles, compréhensibles et validées par l'utilisateur.",
      },
      {
        question: "Pourquoi certains écrans restent privés ?",
        answer:
          "Parce qu'une partie du produit touche à la sécurité, aux règles internes et aux scénarios de surveillance. DEVORA montre assez pour comprendre la valeur, mais garde les détails avancés pour les démonstrations privées.",
      },
    ],
    color: "blue",
  },
