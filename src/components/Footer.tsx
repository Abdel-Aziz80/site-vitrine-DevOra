      ...
      <div className="relative mx-auto max-w-6xl px-6 py-12 md:py-14">
        <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr_0.85fr_1fr]">
          <div>
            <Link
              href="/"
              className="inline-flex items-center gap-3 rounded-2xl border border-white/12 bg-white/5.5 p-2 pr-4 shadow-2xl shadow-[#061A35]/25 transition hover:border-[#22D3EE]/35 hover:bg-white/8"
            >
              <Image
          ...
          <div className="rounded-3xl border border-white/12 bg-white/5.5 p-5 shadow-2xl shadow-[#061A35]/20 backdrop-blur-xl">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[#67E8F9]">
              Réseaux
            </p>
            <div className="mt-4 flex flex-wrap gap-2">
              {socialLinks.map((link) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="rounded-full border border-white/12 bg-white/5.5 px-3 py-2 text-xs font-bold text-white/72 transition hover:border-[#22D3EE]/45 hover:bg-[#22D3EE]/10 hover:text-white"
                >
                  {link.label}
                </a>
              ))}
