...
export const socialLinks = [
  {
    label: "GitHub",
    href: "https://github.com/Abdel-Aziz80",
  },
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/aziz-ayyad-0189bb37b/",
  },
  {
    label: "Malt",
    href: "https://www.malt.fr/profile/azizayyad?origin=dashboard_profile_name",
  },
];
...
export const creationOffers = [
  {
    price: "300€ HT",
    title: "Landing de campagne",
    tag: "Acquisition / Facebook Ads",
    text: "Une page claire pour présenter une offre, capter une demande et mesurer les clics utiles.",
    items: [
      "1 page responsive",
      "Message orienté conversion",
      "CTA visible",
      "SEO de base",
    ],
  },
  {
    price: "600€ HT",
    title: "Plateforme starter",
    tag: "Offre d'appel",
    text: "Une base premium pour poser l'offre, rassurer, expliquer DEVORA ou une activité, puis convertir proprement.",
    items: [
      "Pages essentielles",
  ...
  {
    price: "sur devis",
    title: "Produit DEVORA sur mesure",
    tag: "SaaS, IA, dashboard ou sécurité",
    text: "Un outil sur mesure pour piloter votre activité : dashboard, espace client, automatisation, IA locale, CRM léger, Sentinel ou cockpit business.",
    items: [
      "Cadrage fonctionnel",
      "Interface métier responsive",
      "Tableaux de bord et données",
...
export const trustPillars = [
  {
    title: "Socle full stack certifié",
    text: "Base technique RNCP niveau 5 : responsive, performance, sécurité, SEO, API, déploiement et architecture produit maintenable.",
  },
  {
    title: "Approche business",
    text: "La plateforme n'est pas pensée comme une décoration : l'objectif est de clarifier l'offre, rassurer, préqualifier, automatiser ou générer des demandes.",
  },
  {
    title: "Culture produit",
    text: "DEVORA structure les interfaces comme des outils : parcours, priorités, CTA, données utiles, responsive et base technique prête à évoluer.",
  },
];
...
export const processSteps = [
  ...
  },
  {
    num: "2",
    title: "Structure",
    text: "DEVORA structure les pages, les messages, les CTA, les modules et la base SEO autour des besoins réels.",
  },
  {
    num: "3",
    title: "Mise en ligne",
...
export const caseStudies = [
  ...
  },
  {
    ...
    stack: "React, composants UI, logique front",
    features: [
  ...
  },
  {
    ...
    stack: "React, logique métier, UX formulaire",
    features: [
  ...
  },
  {
    ...
    stack: "Figma, UI design, architecture de page",
    features: [
      "Wireframes",
      "Hiérarchie visuelle",
...
export const localPages = {
  ...
  rouen: {
    ...
    localAngle:
      "Je structure votre site pour parler à des clients rouennais : services visibles, zone d'intervention, CTA direct, pages utiles et base SEO locale propre.",
    examples: [
  ...
  caen: {
    ...
    localAngle:
      "Je construis des pages simples à comprendre, avec une structure SEO locale et des appels à l'action adaptés aux prospects qui comparent plusieurs prestataires.",
    examples: [
  ...
  "le-havre": {
    ...
    localAngle:
      "Je mets l'accent sur une présentation claire, des preuves visibles, un contact simple et une base technique propre pour éviter l'effet site abandonné.",
    examples: [
  ...
  evreux: {
    ...
    localAngle:
      "Je travaille la clarté de l'offre, les informations pratiques, le formulaire et les textes SEO locaux pour donner envie de vous contacter.",
    examples: [
